...
import Schedule_Details from "./components/control/Schedule_Details";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          {/* <Route path="/controller/:site_id" element={ <Controller /> } /> */}
          <Route path="/controller" element={ <Controller /> } />
          <Route path="/controloption" element={ <Controloption /> } />
          <Route path="/scheduler/:site_id" element={ <Scheduler_Time /> } />
          <Route path="/controls/:site_id" element={ <Controls /> } />
          <Route path="/Schedule_detail" element={ <Schedule_Details /> } />
