        ...
        <div class="col  text-center">
          <div class="card mt-3 ml-5">
            ...
            <div className='firstdiv'>
             <h6 className='class3'>Valve 1 :-</h6>
             <h6 className='class4'>{item.Valve1=="Close" ?  <h6 style={{color:"red"}}>{item.Valve1}</h6> : <h6 style={{color:"green"}}>{item.Valve1}</h6>}</h6>
             <h6 className='class3'>valve 2 :-</h6>
             <h6 className='class4'>{item.Valve2=="Close" ?  <h6 style={{color:"red"}}>{item.Valve2}</h6> : <h6 style={{color:"green"}}>{item.Valve2}</h6>}</h6>
            </div>
            <div className='firstdiv'>
            <h6 className='class3'>Valve 3 :-</h6>
             <h6 className='class4'>{item.Valve3=="Close" ?  <h6 style={{color:"red"}}>{item.Valve3}</h6> : <h6 style={{color:"green"}}>{item.Valve3}</h6>}</h6>
             <h6 className='class3'>valve 4 :-</h6>
             <h6 className='class4'>{item.Valve4=="Close" ?  <h6 style={{color:"red"}}>{item.Valve4}</h6> : <h6 style={{color:"green"}}>{item.Valve4}</h6>}</h6>
            </div>
            <div className='firstdiv'>
            <h6 className='class3'>Valve 5  :-</h6>
             <h6 className='class4'>{item.Valve5=="Close" ?  <h6 style={{color:"red"}}>{item.Valve5}</h6> : <h6 style={{color:"green"}}>{item.Valve5}</h6>}</h6>
             <h6 className='class3'>valve 6 :-</h6>
             <h6 className='class4'>{item.Valve6=="Close" ?  <h6 style={{color:"red"}}>{item.Valve6}</h6> : <h6 style={{color:"green"}}>{item.Valve6}</h6>}</h6>
            </div>
            <div className='firstdiv'>
            <h6 className='class3'>Valve 7 :-</h6>
             <h6 className='class4'>{item.Valve7=="Close" ?  <h6 style={{color:"red"}}>{item.Valve7}</h6> : <h6 style={{color:"green"}}>{item.Valve7}</h6>}</h6>
             <h6 className='class3'>valve 8 :-</h6>
             <h6 className='class4'>{item.Valve8=="Close" ?  <h6 style={{color:"red"}}>{item.Valve8}</h6> : <h6 style={{color:"green"}}>{item.Valve8}</h6>}</h6>
            </div>
       </div>
            </div>
