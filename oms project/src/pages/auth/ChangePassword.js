...
const ChangePassword = () => {
  ...
  {/* <Routers/> */}
    ...
    {server_error.password2 ? console.log(server_error.password2[0]) : ""} */}
      ...
      {/* <Routers/>  */}
      <Box sx={{marginTop:"4rem",justifyItems:'center', display: 'flex', flexDirection: 'column', flexWrap: 'wrap' }}>
      <h1>Change Password</h1>
     
      <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1,width:"50%",margin:"auto"}} id="password-change-form">
